...
function deleteItemInCart(_id) {
  axios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/delete-cart", {
    _id: _id
  }).then(function (res) {
...
if (admintAreaPath.includes('admin')) {
  Object(function webpackMissingModule() { var e = new Error("Cannot find module './admin'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(socket);
  socket.emit('join', 'adminRoom');
}
socket.on('orderUpdated', function (data) {
  var updatedOrder = _objectSpread({}, order); //copy object
  updatedOrder.updatedAt = moment__WEBPACK_IMPORTED_MODULE_1__().format();
